    ...
    <main class="overflow-y-scroll overflow-hidden grow h-full relative" style="contain: content">
        ...
        <ul class="p-2 grid w-full spacey-y-2">
            <li class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2">
                ...
                <aside class="grid grid-cols-12 w-fall">
                    <a href="" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hiddin truncate leading-5 w-full flex-nowrap p-1">
                        {{--Name and Date--}}
                        <div class="flex justify-between w-full items-center">
                            <h6 class="truncate font-medium tracking-wider text-gray-500">
                                Shan Harsha
                            </h6>
                            <small class="text-gray-700">4d</small>
                        </div>
                        {{--Message--}}
                        <div class="flex gap-x-2 items-center">
                            ...
                            <p class="grow truncate text-sm font-[100]">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, ullam dolor aliquam blanditiis eum corrupti at ex recusandae asperiores voluptates culpa, unde, quis quaerat odit nemo sunt et ab sit.
                            </p>

                            {{--unread count--}}
                            <span class="font-bold p-px px-2 text-xs shrink-0 rounded-full bg-green-500 text-white">5</span>
                        </div>
                    </a>
