<dive class="w-full overflow-hidden">
    ...
    <main class="flex flex-col gap-3 p-2.5 overflow-y-auto  flex-grow overscroll-contain overflow-x-hidden w-full my-auto">
        ...
        <div @class([
            ...
            <div @class(['flex flex-wrap text-[15px]  rounded-xl p-2.5 flex flex-col text-black bg-[#f6f6f8fb]',
                         ...
                         'rounded-br-none bg-green-500/80 text-white'
               ])>

               <p class="text-sm tracking-wide truncate whitespace-normal md:text-base lg:tracking-normal">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Et quis molestias perspiciatis deserunt recusandae optio, magni error ipsa non suscipit facilis nemo esse voluptates praesentium eveniet, porro eum incidunt dolorem.
               </p>
                ...
                5.23 am
                 ...
                 <div>
                     ...
                     <span  @class('text-gray-200')>
                         <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4256bb" class="bi bi-check2-all" viewBox="0 0 16 16">
